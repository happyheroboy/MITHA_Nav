...
vidObj = VideoReader('E:\Marker_v3.0(1)\Marker_v3.0\Data\marker.mp4');
vid = VideoWriter('E:\Marker_v3.0(1)\Marker_v3.0\markerRecognized.mp4');
open(vid)
fig = figure;
while hasFrame(vidObj)
    ...
    expectN = 4*(size(sta,1)+1)*(size(sta,2)+1);
